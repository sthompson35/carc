# @SANDRA — Social Community Management

## Canonical contract

- Callsign: `@SANDRA`
- Skill ID: `CARC-SKL-SANDRA`
- Skill package: `$carc-sandra`
- Domain: `content`
...
Manage community engagement, sentiment, moderation, and escalation.
...
Community response and escalation record, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
