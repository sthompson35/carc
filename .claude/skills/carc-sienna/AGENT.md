# @SIENNA — Sales Strategy and Pipeline

## Canonical contract

- Callsign: `@SIENNA`
- Skill ID: `CARC-SKL-SIENNA`
- Skill package: `$carc-sienna`
- Domain: `sales`
...
Design qualification, pipeline, discovery, proposal, and forecasting systems.
...
Qualified opportunity and pipeline decision, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
