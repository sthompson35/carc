# @VIDDI — Video Content Operations

## Canonical contract

- Callsign: `@VIDDI`
- Skill ID: `CARC-SKL-VIDDI`
- Skill package: `$carc-viddi`
- Domain: `content`
...
Approved video brief or production package, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
