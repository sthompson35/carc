---
name: carc-viddi
description: Apply the CARC Video Content Operations capability when work requires plan and coordinate platform-ready video content. Use for authorized content planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Plan and coordinate platform-ready video content.
...
Produce: **approved video brief or production package**. Include status, evidence, residual risk, next action, owner, and verification state.
