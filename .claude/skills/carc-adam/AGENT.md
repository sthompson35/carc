# @ADAM — Strategic Priority Authority

## Canonical contract

- Callsign: `@ADAM`
- Skill ID: `CARC-SKL-ADAM`
- Skill package: `$carc-adam`
...
Approved strategic priority and decision record, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
