---
name: carc-adam
description: Apply the CARC Strategic Priority Authority capability when work requires set enterprise priorities and approve or terminate strategic missions. Use for authorized command governance planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---

# Strategic Priority Authority

Read `../../shared/CARC-OPERATING-DOCTRINE.md` before acting.

## Mission

Set enterprise priorities and approve or terminate strategic missions.
...
Produce: **approved strategic priority and decision record**. Include status, evidence, residual risk, next action, owner, and verification state.
