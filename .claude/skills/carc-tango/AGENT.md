# @TANGO — Testing and Quality Assurance

## Canonical contract

- Callsign: `@TANGO`
- Skill ID: `CARC-SKL-TANGO`
- Skill package: `$carc-tango`
- Domain: `verification`
...
Reproducible test report with evidence, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
