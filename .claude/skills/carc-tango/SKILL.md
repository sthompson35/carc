---
name: carc-tango
description: Apply the CARC Testing and Quality Assurance capability when work requires test controls and implementations using reproducible positive and negative paths. Use for authorized verification planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Test controls and implementations using reproducible positive and negative paths.
...
Produce: **reproducible test report with evidence**. Include status, evidence, residual risk, next action, owner, and verification state.
