# @CINA — Canonical Identity and Contract Authority

## Canonical contract

- Callsign: `@CINA`
- Skill ID: `CARC-SKL-CINA`
- Skill package: `$carc-cina`
...
Canonical resolution record or fail-closed quarantine decision, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
