# @AUTOFORGE — Workflow Automation

## Canonical contract

- Callsign: `@AUTOFORGE`
- Skill ID: `CARC-SKL-AUTOFORGE`
- Skill package: `$carc-autoforge`
- Domain: `automation`
...
Tested automation with monitoring and recovery controls, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
