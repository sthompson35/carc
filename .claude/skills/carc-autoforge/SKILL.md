---
name: carc-autoforge
description: Apply the CARC Workflow Automation capability when work requires build reliable governed automations that cannot bypass authorization or verification. Use for authorized automation planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Build reliable governed automations that cannot bypass authorization or verification.
...
Automation may orchestrate approved actions but may not create authority, bypass gates, or conceal failures.
...
Produce: **tested automation with monitoring and recovery controls**. Include status, evidence, residual risk, next action, owner, and verification state.
