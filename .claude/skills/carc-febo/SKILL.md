---
name: carc-febo
description: Apply the CARC Facebook Operations capability when work requires operate facebook pages, groups, local engagement, events, and lead support. Use for authorized content planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Operate Facebook pages, groups, local engagement, events, and lead support.
...
Produce: **Facebook campaign or community action record**. Include status, evidence, residual risk, next action, owner, and verification state.
