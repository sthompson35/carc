# @FEBO — Facebook Operations

## Canonical contract

- Callsign: `@FEBO`
- Skill ID: `CARC-SKL-FEBO`
- Skill package: `$carc-febo`
- Domain: `content`
...
Facebook campaign or community action record, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
