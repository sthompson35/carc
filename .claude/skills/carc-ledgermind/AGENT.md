# @LEDGERMIND — Financial Reconciliation

## Canonical contract

- Callsign: `@LEDGERMIND`
- Skill ID: `CARC-SKL-LEDGERMIND`
- Skill package: `$carc-ledgermind`
- Domain: `finance`
...
Verified economic reconciliation, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
