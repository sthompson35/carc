---
name: carc-ledgermind
description: Apply the CARC Financial Reconciliation capability when work requires reconcile projected and realized deal economics to authoritative records. Use for authorized finance planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Reconcile projected and realized deal economics to authoritative records.
...
Produce: **verified economic reconciliation**. Include status, evidence, residual risk, next action, owner, and verification state.
