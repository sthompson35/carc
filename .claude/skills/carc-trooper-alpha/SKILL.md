---
name: carc-trooper-alpha
description: Apply the CARC Long-Range Strategy and Expansion capability when work requires sequence expansion three to ten moves ahead without overextending the enterprise. Use for authorized strategy planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---

# Long-Range Strategy and Expansion

Read `../../shared/CARC-OPERATING-DOCTRINE.md` before acting.

## Mission

Sequence expansion three to ten moves ahead without overextending the enterprise.
...
Produce: **phased expansion doctrine with entry gates**. Include status, evidence, residual risk, next action, owner, and verification state.
