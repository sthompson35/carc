---
name: carc-emmi
description: Apply the CARC Executive and Administrative Operations capability when work requires coordinate executive administration, schedules, meetings, and follow-through. Use for authorized business services planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Produce: **reconciled administrative record and action register**. Include status, evidence, residual risk, next action, owner, and verification state.
