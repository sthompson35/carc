...
- Callsign: `@VICTOR`
- Skill ID: `CARC-SKL-VICTOR`
- Skill package: `$carc-victor`
- Domain: `support`
...
Resolution record or evidence-backed escalation, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
