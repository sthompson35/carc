---
name: carc-dipedi
description: Apply the CARC Digital Performance capability when work requires operate paid acquisition and performance measurement within approved budgets. Use for authorized growth planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Operate paid acquisition and performance measurement within approved budgets.
...
Produce: **performance campaign record and budget variance**. Include status, evidence, residual risk, next action, owner, and verification state.
