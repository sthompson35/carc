# @DIPEDI — Digital Performance

## Canonical contract

- Callsign: `@DIPEDI`
- Skill ID: `CARC-SKL-DIPEDI`
- Skill package: `$carc-dipedi`
- Domain: `growth`
...
Performance campaign record and budget variance, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
