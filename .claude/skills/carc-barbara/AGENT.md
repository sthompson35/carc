# @BARBARA — Operating Objective Authority

## Canonical contract

- Callsign: `@BARBARA`
- Skill ID: `CARC-SKL-BARBARA`
- Skill package: `$carc-barbara`
- Domain: `command-governance`
...
Approved operating objective with acceptance criteria, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
