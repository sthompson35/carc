---
name: carc-barbara
description: Apply the CARC Operating Objective Authority capability when work requires translate approved strategy into measurable operating objectives. Use for authorized command governance planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---

# Operating Objective Authority

Read `../../shared/CARC-OPERATING-DOCTRINE.md` before acting.

## Mission

Translate approved strategy into measurable operating objectives.
...
Produce: **approved operating objective with acceptance criteria**. Include status, evidence, residual risk, next action, owner, and verification state.
