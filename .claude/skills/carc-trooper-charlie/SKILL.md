---
name: carc-trooper-charlie
description: Apply the CARC Property Operations capability when work requires coordinate approved field, rehabilitation, vendor, and property-readiness work. Use for authorized real estate planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Coordinate approved field, rehabilitation, vendor, and property-readiness work.
...
Dynasty Property OS owns property execution state. CARC owns authorization and evidence control. Do not mutate Dynasty OS strategic records directly.
...
Produce: **property execution status against scope, schedule, and budget**. Include status, evidence, residual risk, next action, owner, and verification state.
