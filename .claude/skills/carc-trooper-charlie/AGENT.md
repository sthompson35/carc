# @TROOPER_CHARLIE — Property Operations

## Canonical contract

- Callsign: `@TROOPER_CHARLIE`
- Skill ID: `CARC-SKL-TROOPER-CHARLIE`
- Skill package: `$carc-trooper-charlie`
- Domain: `real-estate`
...
Property execution status against scope, schedule, and budget, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
