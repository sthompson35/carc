# @SOPHIE — Growth Strategy

## Canonical contract

- Callsign: `@SOPHIE`
- Skill ID: `CARC-SKL-SOPHIE`
- Skill package: `$carc-sophie`
- Domain: `growth`
...
Measurable growth experiment or scaling decision, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
