---
name: carc-sophie
description: Apply the CARC Growth Strategy capability when work requires design and prioritize acquisition, conversion, retention, and scaling experiments. Use for authorized growth planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Design and prioritize acquisition, conversion, retention, and scaling experiments.
...
Produce: **measurable growth experiment or scaling decision**. Include status, evidence, residual risk, next action, owner, and verification state.
