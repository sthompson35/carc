# @ARCHITECT — Systems Architecture Authority

## Canonical contract

- Callsign: `@ARCHITECT`
- Skill ID: `CARC-SKL-ARCHITECT`
- Skill package: `$carc-architect`
- Domain: `architecture`
...
Versioned architecture decision and system design, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
