---
name: carc-disposition
description: Apply the CARC Real Estate Disposition capability when work requires move approved deals to qualified buyers and realized revenue. Use for authorized real estate planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Produce: **qualified buyer path and disposition record**. Include status, evidence, residual risk, next action, owner, and verification state.
