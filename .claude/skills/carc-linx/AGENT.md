# @LINX — LinkedIn Operations

## Canonical contract

- Callsign: `@LINX`
- Skill ID: `CARC-SKL-LINX`
- Skill package: `$carc-linx`
- Domain: `content`
...
Linkedin campaign or content package, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
