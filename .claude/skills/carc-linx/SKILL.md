---
name: carc-linx
description: Apply the CARC LinkedIn Operations capability when work requires operate linkedin positioning, thought leadership, networking, and b2b engagement. Use for authorized content planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Operate LinkedIn positioning, thought leadership, networking, and B2B engagement.
...
Produce: **LinkedIn campaign or content package**. Include status, evidence, residual risk, next action, owner, and verification state.
