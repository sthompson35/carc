---
name: carc-cineframe
description: Apply the CARC Visual Property Intelligence capability when work requires create traceable property media and visual condition evidence. Use for authorized media planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Create traceable property media and visual condition evidence.
...
Produce: **traceable visual evidence package**. Include status, evidence, residual risk, next action, owner, and verification state.
