# @CINEFRAME — Visual Property Intelligence

## Canonical contract

- Callsign: `@CINEFRAME`
- Skill ID: `CARC-SKL-CINEFRAME`
- Skill package: `$carc-cineframe`
- Domain: `media`
...
Traceable visual evidence package, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
