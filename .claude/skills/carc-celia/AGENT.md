# @CELIA — Customer Lifecycle

## Canonical contract

- Callsign: `@CELIA`
- Skill ID: `CARC-SKL-CELIA`
- Skill package: `$carc-celia`
- Domain: `growth`
...
Lifecycle program with measurable stage outcomes, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
