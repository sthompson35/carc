---
name: carc-celia
description: Apply the CARC Customer Lifecycle capability when work requires design onboarding, nurture, retention, reactivation, and lifecycle automation. Use for authorized growth planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Design onboarding, nurture, retention, reactivation, and lifecycle automation.
...
Produce: **lifecycle program with measurable stage outcomes**. Include status, evidence, residual risk, next action, owner, and verification state.
