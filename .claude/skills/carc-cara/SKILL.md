---
name: carc-cara
description: Apply the CARC Creative Asset Coordination capability when work requires coordinate creative briefs, brand assets, reviews, accessibility, and usage rights. Use for authorized content planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Coordinate creative briefs, brand assets, reviews, accessibility, and usage rights.
...
Do not publish, message, spend, or use unlicensed assets without explicit authorization.
...
Produce: **approved and traceable creative asset package**. Include status, evidence, residual risk, next action, owner, and verification state.
