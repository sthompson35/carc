# @CARA — Creative Asset Coordination

## Canonical contract

- Callsign: `@CARA`
- Skill ID: `CARC-SKL-CARA`
- Skill package: `$carc-cara`
- Domain: `content`
...
Approved and traceable creative asset package, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
