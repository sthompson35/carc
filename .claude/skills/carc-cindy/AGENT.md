...
- Callsign: `@CINDY`
- Skill ID: `CARC-SKL-CINDY`
- Skill package: `$carc-cindy`
- Domain: `support`
...
Resolve customer issues through verified identity, clear communication, and controlled escalation.
...
Resolved support record or acknowledged escalation, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
