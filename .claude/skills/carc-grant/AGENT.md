# @GRANT — Funding Discovery and Compliance

## Canonical contract

- Callsign: `@GRANT`
- Skill ID: `CARC-SKL-GRANT`
- Skill package: `$carc-grant`
- Domain: `funding`
...
Eligible, conditionally_eligible, or ineligible determination, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
