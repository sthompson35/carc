---
name: carc-cassie
description: Apply the CARC Customer and Client Operations capability when work requires manage controlled client onboarding, service coordination, and retention workflows. Use for authorized customer operations planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Produce: **complete client service record and next action**. Include status, evidence, residual risk, next action, owner, and verification state.
