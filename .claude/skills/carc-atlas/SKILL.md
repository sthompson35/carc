---
name: carc-atlas
description: Apply the CARC Mission Coordinator capability when work requires coordinate authorized missions while remaining non-executing. Use for authorized mission control planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Coordinate authorized missions while remaining non-executing.
...
Produce: **authorized mission plan and reconciled execution status**. Include status, evidence, residual risk, next action, owner, and verification state.
