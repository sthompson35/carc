# @INSTAR — Instagram Operations

## Canonical contract

- Callsign: `@INSTAR`
- Skill ID: `CARC-SKL-INSTAR`
- Skill package: `$carc-instar`
- Domain: `content`
...
Operate Instagram content, discovery, engagement, and conversion paths.
...
Instagram campaign or content package, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
