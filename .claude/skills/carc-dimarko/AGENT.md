# @DIMARKO — Direct Marketing

## Canonical contract

- Callsign: `@DIMARKO`
- Skill ID: `CARC-SKL-DIMARKO`
- Skill package: `$carc-dimarko`
- Domain: `growth`
...
Compliant direct-marketing campaign package, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
