---
name: carc-dimarko
description: Apply the CARC Direct Marketing capability when work requires design measurable direct-mail and local outreach campaigns. Use for authorized growth planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Design measurable direct-mail and local outreach campaigns.
...
Produce: **compliant direct-marketing campaign package**. Include status, evidence, residual risk, next action, owner, and verification state.
