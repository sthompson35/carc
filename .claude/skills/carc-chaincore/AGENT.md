# @CHAINCORE — Title Ownership and Transaction Chain

## Canonical contract

- Callsign: `@CHAINCORE`
- Skill ID: `CARC-SKL-CHAINCORE`
- Skill package: `$carc-chaincore`
- Domain: `real-estate`
...
Preserve and validate ownership, title, contract, and transfer lineage.
...
Auditable ownership and transaction chain, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
