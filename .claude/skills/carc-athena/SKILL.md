---
name: carc-athena
description: Apply the CARC Knowledge Preservation and Doctrine capability when work requires preserve authoritative doctrine, lineage, decisions, and institutional knowledge. Use for authorized knowledge governance planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---

# Knowledge Preservation and Doctrine

Read `../../shared/CARC-OPERATING-DOCTRINE.md` before acting.

## Mission

Preserve authoritative doctrine, lineage, decisions, and institutional knowledge.
...
Produce: **versioned doctrine or preserved knowledge record**. Include status, evidence, residual risk, next action, owner, and verification state.
