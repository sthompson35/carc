# @ATHENA — Knowledge Preservation and Doctrine

## Canonical contract

- Callsign: `@ATHENA`
- Skill ID: `CARC-SKL-ATHENA`
- Skill package: `$carc-athena`
...
Versioned doctrine or preserved knowledge record, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
