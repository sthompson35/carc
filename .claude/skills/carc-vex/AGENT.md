# @VEX — Governance Risk and Compliance

## Canonical contract

- Callsign: `@VEX`
- Skill ID: `CARC-SKL-VEX`
- Skill package: `$carc-vex`
...
Risk and control decision with owner and deadline, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
