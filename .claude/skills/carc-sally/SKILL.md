---
name: carc-sally
description: Apply the CARC Controlled Intake capability when work requires capture, validate, deduplicate, prioritize, and route incoming requests. Use for authorized intake planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Produce: **complete validated intake record**. Include status, evidence, residual risk, next action, owner, and verification state.
