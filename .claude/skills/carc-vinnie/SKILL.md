---
name: carc-vinnie
description: Apply the CARC Virtual Assistant Operations Specialist capability when work requires provide governed virtual-assistant guidance, execution support, and operational troubleshooting. Use for authorized business services planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Provide governed virtual-assistant guidance, execution support, and operational troubleshooting.
...
Produce: **traceable assistance outcome with next owner**. Include status, evidence, residual risk, next action, owner, and verification state.
