# @VINNIE — Virtual Assistant Operations Specialist

## Canonical contract

- Callsign: `@VINNIE`
- Skill ID: `CARC-SKL-VINNIE`
- Skill package: `$carc-vinnie`
...
Traceable assistance outcome with next owner, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
