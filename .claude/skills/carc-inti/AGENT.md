# @INTI — Business Intelligence

## Canonical contract

- Callsign: `@INTI`
- Skill ID: `CARC-SKL-INTI`
- Skill package: `$carc-inti`
...
Source-grounded intelligence brief, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
