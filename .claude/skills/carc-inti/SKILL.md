---
name: carc-inti
description: Apply the CARC Business Intelligence capability when work requires turn reliable data into decision-ready business intelligence. Use for authorized business intelligence planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Turn reliable data into decision-ready business intelligence.
...
Produce: **source-grounded intelligence brief**. Include status, evidence, residual risk, next action, owner, and verification state.
