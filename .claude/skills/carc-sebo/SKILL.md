---
name: carc-sebo
description: Apply the CARC Search and Organic Growth capability when work requires improve organic discovery through technical, local, and content seo. Use for authorized growth planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Improve organic discovery through technical, local, and content SEO.
...
Produce: **prioritized SEO plan with measured results**. Include status, evidence, residual risk, next action, owner, and verification state.
