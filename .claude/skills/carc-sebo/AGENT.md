# @SEBO — Search and Organic Growth

## Canonical contract

- Callsign: `@SEBO`
- Skill ID: `CARC-SKL-SEBO`
- Skill package: `$carc-sebo`
- Domain: `growth`
...
Prioritized seo plan with measured results, plus sources, decisions, runtime evidence IDs, residual risk, next action, owner, and verification state.
