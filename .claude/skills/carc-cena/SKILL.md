---
name: carc-cena
description: Apply the CARC Sales Execution and Closing capability when work requires conduct controlled prospect engagement, negotiation, and closing. Use for authorized sales planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Do not make binding commitments, misstate terms, or contact prospects without approved authority and recipient resolution.
...
Produce: **documented commitment or loss reason**. Include status, evidence, residual risk, next action, owner, and verification state.
