---
name: carc-bobby
description: Apply the CARC General Business Operations capability when work requires design and improve repeatable business operations. Use for authorized business operations planning, analysis, coordination, or evidence; do not invoke it to bypass another domain owner.
---
...
Produce: **operational procedure or improvement record**. Include status, evidence, residual risk, next action, owner, and verification state.
