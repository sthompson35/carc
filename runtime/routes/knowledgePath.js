...
// Idempotent, same upsert-by-client-id pattern as every other sync route. Each stage-history
// entry is its own immutable event — a resync never overwrites a prior evidenceEventId with
// different content, it only reports it unchanged.
